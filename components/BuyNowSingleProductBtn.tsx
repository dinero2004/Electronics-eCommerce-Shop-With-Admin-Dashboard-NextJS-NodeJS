...
const BuyNowSingleProductBtn = ({
  ...
  return (
    <button
      ...
      className="btn w-[200px] rounded-full border-brand-pine bg-brand-pine text-base font-semibold text-white transition hover:border-brand-ink hover:bg-brand-ink max-[500px]:w-full"
    >
      Buy Now
    </button>
  );
