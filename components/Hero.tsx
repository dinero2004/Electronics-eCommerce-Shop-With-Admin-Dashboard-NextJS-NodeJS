...
const Hero = () => {
  return (
    <div className="h-[700px] w-full bg-[#A5CCD1] max-lg:h-[900px] max-md:h-[750px]">
      <div className="grid grid-cols-3 items-center justify-items-center px-10 gap-x-10 max-w-screen-2xl mx-auto h-full max-lg:grid-cols-1 max-lg:py-10 max-lg:gap-y-10">
        <div className="flex flex-col gap-y-5 max-lg:order-last col-span-2">
          ...
          <div className="flex gap-x-1 max-lg:flex-col max-lg:gap-y-1">
            <Link href="/shop" className="bg-white text-center text-[#A5CCD1] font-bold px-12 py-3 max-lg:text-xl max-sm:text-lg hover:bg-gray-100">
              SHOP NOW
            </Link>
            <Link href="/register" className="border border-white text-center text-white font-bold px-12 py-3 max-lg:text-xl max-sm:text-lg hover:bg-[#A5CCD1]">
              CREATE ACCOUNT
            </Link>
          </div>
        </div>
